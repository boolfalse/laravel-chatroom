                    ...
                    <div class="discussions" id="scroller">
                        ...
                        <div class="list-group" id="chats" role="tablist">
                            @foreach($users as $user)
                                <a href="#list-chat" class="filterDiscussions all unread single {{ $user->id == $speaker->id ? 'active' : '' }}" id="list-chat-list" data-toggle="list" role="tab">
                                    <img class="avatar-md" src="{{ asset('uploads/' . config('custom.user_images_folder') . '/small/' . $user->image) }}" data-toggle="tooltip" data-placement="top" title="{{ $user->first_name }}" alt="avatar">
                                    <div class="status online"></div>
                                    <div class="data">
                                        <h5>{{ $user->name }}</h5>
